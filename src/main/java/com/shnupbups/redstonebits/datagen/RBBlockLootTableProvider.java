...
public class RBBlockLootTableProvider extends FabricBlockLootTableProvider {
	protected RBBlockLootTableProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookupFuture) {
